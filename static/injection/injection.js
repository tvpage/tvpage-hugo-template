      ...
      return function(){
        ...
        (function(d, s) {
          ...
          __TVPage__.config[id] = {
            debug: Number("") || 0,
            targetEl: id,
            onPlayerChange : function(e, stateData){
              console.log("Solo", e, stateData);
            }
          };
      ...
      return function(){
        ...
        (function(d, s) {
          ...
          __TVPage__.config[id] = {
            debug: Number("") || 0,
            targetEl: id,
            onPlayerChange : function(e, data){
              console.log("Static",e,data);
            }
          };
      ...
      return function(){
        ...
        (function(d, s) {
          ...
          __TVPage__.config[id] = {
            ...
            targetEl: id,
            onPlayerChange : function(e, stateData){
              console.log("Static", e, stateData);
            }
          };
...
if(widgetTested){
  ...
  console.log("widget not found : ",widgetToTest);
}
