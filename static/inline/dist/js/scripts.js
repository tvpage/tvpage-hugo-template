...
(function($) {
  ...
  Player.prototype.createAsset = function (obj) {
  ...
  Player.prototype.addAssets = function (objs) {
    ...
    for (var i = 0; i < objsLength; i++) {
      ...
      if (!this.getAssetById(obj.id)) {
        this.assets.push(this.createAsset(obj));
      }
    }
  };
