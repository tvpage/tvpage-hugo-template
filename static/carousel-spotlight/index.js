...
var hostCssTagId = "tvp-carousel-spotlight-host-css";
var hostCssTag = "";
...
targetElement.insertAdjacentHTML('beforebegin', hostCssTag + '<style>' + config.css["host-custom" + (utils.isMobile ? "-mobile" : "")] + '</style><div id="' + id + '-holder" class="tvp-carousel-spotlight-holder">'+
'<iframe src="about:blank" allowfullscreen frameborder="0" scrolling="no"></iframe></div>');
targetElement.parentNode.removeChild(targetElement);

config.id = id;
config.staticPath = config.baseUrl + "/carousel-spotlight";
...
var iframeContent = utils.getIframeHtml({
    ...
    js: [
        "//a.tvpage.com/local/tvpa.min.js",
        config.baseUrl+'carousel-spotlight/js/libs/analytics.js',
