...
define('text!tmpl/skeleton.html',[],function () { return '<style type="text/css">\n\t.tvp-skeleton {\n\t  box-sizing: border-box;\n\t}\n\t.tvp-skeleton:before,\n\t.tvp-skeleton:after{\n\t  display: table;\n\t  content: " ";\n\t  clear: both;\n\t  box-sizing: border-box;\n\t}\n\t.tvp-skeleton-item {\n\t  float: left;\n\t box-sizing: border-box;\n\t width: 32%;\n\t margin-right:2%;\n\t}\n\t.tvp-skeleton-item:last-child {\n\t margin-right:0;\n\t}\n\t.tvp-skeleton-item-img {\n\t    box-sizing: border-box;\n\t    background-color: #f7f7f7;\n\t    padding-top: 56.25%;\n\t    border: 1px solid #e8e8e8;\n\t}\n\t.tvp-skeleton-item-txt {\n\t  box-sizing: border-box;\n\t  height: 9px;\n\t  background-color: #f7f7f7;\n\t  margin-top: 10px;\n\t  border: 1px solid #e8e8e8;\n\t}\n\t.tvp-skeleton-item-txt-half {\n\t    box-sizing: border-box;\n\t    height: 9px;\n\t    background-color: #f7f7f7;\n\t    margin-top: 10px;\n\t    border: 1px solid #e8e8e8;\n\t    width: 40%;\n\t}\n</style>\n<div class="tvp-skeleton">\n\t<div class="tvp-skeleton-item">\n\t    <div class="tvp-skeleton-item-img"></div>\n\t    <div class="tvp-skeleton-item-txt"></div>\n\t    <div class="tvp-skeleton-item-txt-half"></div>\n\t</div>\n\t<div class="tvp-skeleton-item">\n\t    <div class="tvp-skeleton-item-img"></div>\n\t    <div class="tvp-skeleton-item-txt"></div>\n\t    <div class="tvp-skeleton-item-txt-half"></div>\n\t</div>\n\t<div class="tvp-skeleton-item">\n\t    <div class="tvp-skeleton-item-img"></div>\n\t    <div class="tvp-skeleton-item-txt"></div>\n\t    <div class="tvp-skeleton-item-txt-half"></div>\n\t</div>\n</div>';});

define('src/js/defaults',{
    target: '',
    textColor: '#6e6e6e',
    arrowStyle: 'flat',
    carousel: {
      ...
      slidesToScroll: 3,
      speed: 200,
      appendArrows:'.tvpcarousel-arrows'
    },
    lightbox: {
      overlayClassName: '.tvplightbox-overlay',
      bodyClassName: '.tvplightbox-body'
    }
});


define('text!tmpl/lightbox.html',[],function () { return '<div class="tvplightbox off">\n\t<div class="tvplightbox-content">\n\t\t<div class="lb-header">\n\t    \t<button class="tvplightbox-close"></button>\n\t    \t<a id="watch_more_link" href="<%= headerLink %>" target="_blank" class="watch-more-tvp">\n\t    \t\t<span><span><%= headerLinkText %></span></span>\n    \t\t</a>\n    \t\t<h4 class="tvplightbox-title"></h4>\n\t\t</div>\n\t\t<div class="tvplightbox-body"></div>\n\t</div>\n\t<div class="tvplightbox-overlay"></div>\n</div>';});
...
define('text!tmpl/products-desktop.html',[],function () { return '<% if (products.length) { %>\n\t<div class="scrollable">\n\t\t<div class="scroll-list">\n\t   <% _.each(products, function(product){ %>\n\t    <% if (product.id){ %>\n\t   \t\t\t<div>\n\t\t\t\t\t<a id="product-<%= product.id %>" href="<%= product.linkUrl %>" class="product" data-pid="<%= product.id %>" data-parent="<%= product.entityIdParent %>" target="_blank">\n\t\t\t\t\t\t<div class="ar-content" style="background-image:url(<%= product.imageUrl %>);"></div>\n\t\t\t\t\t</a>\n\t\t\t\t\t<div id="product-popup-<%= product.id %>" data-pid="<%= product.id %>" data-parent="<%= product.entityIdParent %>" class="product-popup" target="_blank">\n\t\t\t\t\t\t<div class="poster-contain product-img"><div class="ar-content" style="background-image:url(<%= product.imageUrl %>);"></div></div>\n\t\t\t\t\t\t<h2 class="product-title" data-pid="<%= product.id %>" data-parent="<%= product.entityIdParent %>"><a href="<%= product.linkUrl %>" target="_blank"><%= product.title %></a></h2>\n\t\t\t\t\t\t<p class="product-price">$<span class="product-price-holder"><%= product.price %></span></p>\n\t\t\t\t\t\t<button class="call-to-action">View Details</button>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t    <% } %>\n\t   <% }); %>\n   \t\t</div>\n\t</div>\n<% } %>';});

define('src/js/products/index',['require','underscore','jquery-private','iscroll','../jquery.pubsub-loader','slick','text!tmpl/products-mobile.html','text!tmpl/products-desktop.html'],function(require) {
...
define('src/js/index',['require','jquery-private','underscore','./jquery.pubsub-loader','slick','text!tmpl/skeleton.html','./defaults','../../text!tmpl/lightbox.html','./products/index','./player/index'],function(require) {
