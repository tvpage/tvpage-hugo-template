...
define('src/js/index',['require','jquery-private','./jquery.pubsub-loader','slick'],function(require) {
  ...
  for (var i = 0; i < $( "."+type ).length; i++) {
    $( "."+type ).eq( i ).attr( "id", type +"-"+ i );
  }

  $( "."+type ).attr("id",function(i,path){
    $.ajax({ url: "//localhost:1313/"+ path.split('-').join('/') }).done(function( res ){
      console.log( res );
    });
  });
  ...
  //   console.log( __TVPage__.config[i] );
  // }


  // $(".tvpwidget").each(function(i,el){
  //   widgets.push("tvpwidget-"+i);
  //   $(el).attr('id',"tvpwidget-"+i)
  //   console.log(i);
  //   console.log($(el);
  // });
