    ...
    function c(c, d) {
        ...
        this.init = function() {
            ...
            if (!(a.length < 1)) {
                ...
                for (var i = 0; i < a.length; i++) {
                    ...
                    g.innerHTML += Utils.tmpl(d.templates["menu-item"], j), Utils.isset(d, "menu_item_play_category_tag_attribute") && ("" + d.menu_item_play_category_tag_attribute).trim().length) {
                        var k = d.menu_item_play_category_tag_attribute, l = j[k];
                        if (l) {
                            l = l.replace(/_/g, " ");
                            var m = b.createDocumentFragment(), n = b.createElement("div");
                            n.classList.add("tvp-category-tag"), n.innerHTML += l, m.appendChild(n), c[i].appendChild(m);
                        }
                    }
                    if ("static" !== e.dataMethod && a.length > 4) {
                        var o = b.createDocumentFragment(), p = b.createElement("div");
                        p.classList.add("tvp-no-videos"), o.appendChild(p), h.appendChild(o);
                    }
                }
            ...
            if (e.noVideosContainer) {
                e.deleteDivs();
                for (var f = 0; f < a.length; f++) if (c[f], e.allVideos.push(a[f]), d.data.push(a[f]), 
                e.noVideosContainer.setAttribute("id", "tvp-clearfix"), a[f].duration = Utils.formatDuration(a[f].duration), 
                e.noVideosContainer.innerHTML += Utils.tmpl(d.templates["menu-item"], a[f]), e.scrollMenu.appendChild(e.noVideosContainer), 
                Utils.isset(d, "menu_item_play_category_tag_attribute") && ("" + d.menu_item_play_category_tag_attribute).trim().length) {
                    var g = (d.menu_item_play_category_tag_attribute, a[f][d.menu_item_play_category_tag_attribute]);
                    if (g) {
                        g = g.replace(/_/g, " ");
                        var h = b.createDocumentFragment(), i = b.createElement("div");
                        i.classList.add("tvp-category-tag"), i.innerHTML += g, h.appendChild(i), e.noVideosContainer.getElementsByClassName("tvp-video-details")[f].appendChild(h);
                    }
                }
            } else for (var j = b.createDocumentFragment(), k = b.createElement("div"), f = 0; f < a.length; f++) if (c[f], 
            e.allVideos.push(a[f]), d.data.push(a[f]), k.setAttribute("id", "tvp-clearfix"), 
            a[f].duration = Utils.formatDuration(a[f].duration), k.innerHTML += Utils.tmpl(d.templates["menu-item"], a[f]), 
            j.appendChild(k), e.scrollMenu.appendChild(k), Utils.isset(d, "menu_item_play_category_tag_attribute") && ("" + d.menu_item_play_category_tag_attribute).trim().length) {
                var g = (d.menu_item_play_category_tag_attribute, a[f][d.menu_item_play_category_tag_attribute]);
                if (g) {
                    g = g.replace(/_/g, " ");
                    var h = b.createDocumentFragment(), i = b.createElement("div");
                    i.classList.add("tvp-category-tag"), i.innerHTML += g, h.appendChild(i), k.getElementsByClassName("tvp-video-details")[f].appendChild(h);
                }
            }
