!function(a, b) {
    function c() {
        ...
        this.debounce = function(a, b, c) {
            ...
            var a = function(a) {
                return c.isset(a) && c.isset(a, "__TVPage__") && c.isset(a.__TVPage__, "config") ? a.__TVPage__.config : null;
            }(parent), d = b.body.getAttribute("data-id");
            if (c.isset(a, d)) {
                var e = a[d];
                return e.name = d, e;
            }
        ...
        if (c && d(i) && d(i.data) && !(i.data.length <= 0)) {
            ...
            this.getOption = function(a) {
                ...
                if (a) {
                    ...
                    b ? ((e || d(this.autonext) && !this.autonext) && (c = !0), this.current = this.getCurrentIndex(a.assetId)) : (e || d(this.autoplay) && !this.autoplay) && (c = !0), 
                    c ? this.instance.cueVideo(a) : this.instance.loadVideo(a);
                }
            }, this.createAsset = function(a) {
                if (a && "object" == typeof a && !e(a) && d(a, "asset")) {
                    var b = a.asset;
                    b.assetId = a.id, b.assetTitle = a.title, b.loginId = a.loginId;
                    var c = d(a, "parentId") ? a.parentId : d(i, "channel") ? i.channel.id : 0;
                    return c || !i.channelId && !i.channelid || (c = i.channelId || i.channelid), b.analyticsObj = {
                        pg: c,
                        vd: a.id,
                        li: a.loginId
                    }, b.sources || (b.sources = [ {
    ...
    function c(c, d) {
        ...
        this.player = c, this.playerEl = c.el, this.allVideos = [], this.init = function() {
            ...
            if (a && a.length) {
                for (var b = !a.length || a.length < d.items_per_page, c = a || [], g = "", h = "", i = 0; i < c.length; i++) {
                    var j = c[i];
                    j.title = Utils.trimText(j.title, 100), j.duration = Utils.formatDuration(j.duration), 
                    j = e.setTagAttribute(d, j), b || (h += '<div class="tvp-no-videos"></div>'), g += Utils.tmpl(d.templates["menu-item"], j), 
                    e.allVideos.push(j);
                }
        ...
        }, this.setTagAttribute = function(a, b) {
            if (Utils.isset(a, "menu_item_play_category_tag_attribute")) {
                var c = b[a.menu_item_play_category_tag_attribute];
                c && (c = c.replace(/_/g, " "), b.menuTagAttr = c);
            }
            return b;
        ...
        !function(a, b, c, e) {
            Utils.render(c, b.body), Utils.loadData(e, c, function(b) {
                if (b && b.length) {
                    ...
                    f.data = b || [];
                    if (!!Utils.isset(e, "playlist") && e.playlist) {
