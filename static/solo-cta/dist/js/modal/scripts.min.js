!function(a, b) {
    ...
    function c() {
        this.initConfig = function(a) {
            ...
            a.cookieDomain && (b.firstPartyCookieDomain = a.cookieDomain), _tvpa.push([ "config", b ]);
                    ...
                    if (d(a, "TVPage") && d(a, "_tvpa")) {
                        for (var c = {
                            ...
                            onReady: function(b, c) {
                                ...
                                var e = i.loginId || i.loginid, f = {
                                    domain: h,
                                    logUrl: l.apiBaseUrl + "/__tvpa.gif",
                                    loginId: e
                                };
                                if (i.cookiedomain && (f.cookieDomain = i.cookiedomain), l.analytics.initConfig(f), 
                                l.analytics.track("ci", {
                                    ...
                                    var k = l.resize;
                                    a.removeEventListener("message", k, !1), a.addEventListener("resize", k);
                                }
                                l.el.querySelector(".tvp-progress-bar").style.backgroundColor = l.progressColor;
                                var m = 0;
                                if (j && j.length) for (var n = 0; n < l.assets.length; n++) l.assets[n].assetId === j && (m = n);
                                l.current = m, l.play(l.assets[l.current]);
                            },
