            ...
            !function b() {
                setTimeout(function() {
                    if (d(a, "TVPage") && d(a, "_tvpa")) {
                        ...
                        l.player = new TVPage.player(c), function(b) {
                            l.analytics = new Analytics();
                            var c = i.loginId || i.loginid;
                            if (l.analytics.initConfig({
                                ...
                                li: c
                            }), l.instance = b, l.resize(), d(a, "BigScreen") && (BigScreen.onchange = function() {
                                ...
                                a.removeEventListener("message", e, !1), a.addEventListener("message", e, !1);
                            } else {
                                var f = l.resize;
                                a.removeEventListener("message", f, !1), a.addEventListener("resize", f);
                            }
                            l.el.querySelector(".tvp-progress-bar").style.backgroundColor = l.progressColor;
                            var g = 0;
                            if (j && j.length) for (var k = 0; k < l.assets.length; k++) l.assets[k].assetId === j && (g = k);
                            l.current = g, l.play(l.assets[l.current]);
                        }(l.player);
                    } else ++m < 50 && b();
                }, 150);
            }();
