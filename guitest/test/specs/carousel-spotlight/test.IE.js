...
/*==========================================*/
var WIDGET = require(__dirname + "/../../../data/carousel-spotlight.js"),
...
module.exports = {
  ...
  'carousel-spotlight-analytics': function (browser) {
    ...
    widget
      ...
      .productSanity(product, 'a[data-id="83102933"]', 'p.product-title', WIDGET.HTML.IFRAME_MODAL, false)
      .pause(5)
