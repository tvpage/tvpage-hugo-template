...
/*==========================================*/
var ANALYTIC = require(__dirname + "/../analytics/carousel-spotlight.counts.js"),
...
module.exports = {
  ...
  playerIframId: 'div#carousel-spotlight-2',
  ...
  'carousel-spotlight-youtube-sanity-analytics': function (browser) {
    var carousel = widget.tvpGUITest({
          'modalOverlay': this.modalOverlay,
          'modalCloseId': this.modalCloseId,
        ...
        client = carousel.init(browser, "Carousel Widget Analytics", "div#carousel-spotlight-2-holder", 0, parent);
    ...
    carousel.productModal(false, product, "a[data-id='83102933']"),
